...
public class TC01_012 {
    ...
    Actions actions;
    @Test
    public void testGoodPassword03() throws IOException {
        ReusableMethods.becomeAVendor();
        registrationPage = new RegistrationPage();
        ReusableMethods.getVerificationCode();
        registrationPage.passwordBox.sendKeys(ConfigReader.getProperty("goodPassword03"));
        registrationPage.confirmPasswordBox.sendKeys(ConfigReader.getProperty("goodPassword03"));
        ReusableMethods.scrollIntoView(registrationPage.registerButton);
        ReusableMethods.waitFor(2);
        registrationPage.registerButton.click();
        ReusableMethods.waitFor(5);
        ReusableMethods.getScreenshot02("GoodPasswordSuccessfulRegistration03  ");
