...
public class TC01_011 {
    ...
    Actions actions;
    @Test
    public void testGoodPassword02() throws IOException {
        ReusableMethods.becomeAVendor();
        registrationPage = new RegistrationPage();
        ReusableMethods.getVerificationCode();
        registrationPage.passwordBox.sendKeys(ConfigReader.getProperty("goodPassword02"));
        registrationPage.confirmPasswordBox.sendKeys(ConfigReader.getProperty("goodPassword02"));
        ReusableMethods.scrollIntoView(registrationPage.registerButton);
        ReusableMethods.waitFor(2);
        registrationPage.registerButton.click();
        ReusableMethods.waitFor(3);
        ReusableMethods.getScreenshot02("GoodPasswordSuccessfulRegistration02  ");
