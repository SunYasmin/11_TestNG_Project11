...
public class TC01_016 {
    ...
    14) Vendor, çok kısa password girer.
    15) Vendor, Confirm Password kutusuna tıklar
    16) Vendor çok kısa password girer
    ...
    public void testTooShortPassword() {
        ...
        registrationPage.passwordBox.sendKeys(ConfigReader.getProperty("tooShortPassword"));
        registrationPage.confirmPasswordBox.sendKeys(ConfigReader.getProperty("tooShortPassword"));
