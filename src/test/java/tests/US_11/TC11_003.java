...
public class TC11_003 {
    ...
    public void test2_minQty() {
        ...
        ReusableMethods.waitFor(2);
        //12. Min Order Quantity kutucuğundaki miktarı temizler, numerik olarak miktar bilgisi girer
        productsPage.minOrderQty.clear();
        Random rndm = new Random();
        int sayi = rndm.nextInt(100);
        String stockQty = String.valueOf(sayi);
        productsPage.minOrderQty.sendKeys(stockQty);
        ReusableMethods.waitFor(2);
