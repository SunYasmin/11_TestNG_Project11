...
public abstract class TestBaseRapor {
    ...
    public void setUpTest() {
        ...
        //Raporu kaydettigi dosyayi gosteriyor/target'in altina yani
        ...
        extentReports.setSystemInfo("Automation Engineer", "Derya");
        extentHtmlReporter.config().setDocumentTitle("Rapor");//basligi rapor
        extentHtmlReporter.config().setReportName("TestNG Reports");//ne raporu? ==> TestNG raporu
    }
    ...
    public void tearDownTest() {
        extentReports.flush();
    } //flush methoduyla sonlandiririz.
